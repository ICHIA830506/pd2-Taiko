...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(420, 390, 161, 91));
        QFont font;
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/images/window.png")));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 0, 581, 181));
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/images/logo.png")));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(600, 390, 161, 91));
